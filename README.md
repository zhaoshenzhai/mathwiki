...
* **Definition**, either of an `object` or of a `notion`, which links to:
    ...
    * Constructions: _Objects/notions derived from `object`/`notion`. (Definition/Proposition)_
...
Some stats: 532 notes, 1183 links, 50 images ([updated](https://github.com/zhaoshenzhai/MathWiki/blob/master/.scripts/stats.sh) every commit).
...
[templatesInsert]: https://github.com/zhaoshenzhai/dotfiles/blob/master/nvim/UltiSnips/vimwiki.snippets#L683
