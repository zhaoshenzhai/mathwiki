...
_Let $\tpl{X,\mc{T}_X}$ and $\tpl{Y,\mc{T}_Y}$ be topological spaces. Then the product topology_ $\mc{T}_\textrm{pr}\coloneqq\mc{T}\l(\mc{B}\r)$ _on $X\times Y$ can be generated by the subbasis_
$$\begin{equation}
...
<center><img src="app://local/home/zhao/Dropbox/MathWiki/Images/2022-02-09_224445/image.svg", width=340></center>
