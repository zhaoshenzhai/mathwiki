...
* (Cyclic): It suffices to find some $\tpl{a,b}\in\Z_m\times\Z_n$ such that $\ord{\tpl{a,b}}=mn$, for then $\ord{\sgrp{\tpl{a,b}}}=mn=\ord{\Z_m\times\Z_n}$ and so $\sgrp{\tpl{a,b}}=\Z_m\times\Z_n$. Indeed, take $a=b=1$ and observe that
$$\begin{equation}
