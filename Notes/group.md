...
Each homomorphism induce $f$ canonical subgroups $-$ i.e. subsets $A\subseteq G$ where $A\into G$ is a homomorphism: its *kernel* $\ker f\coloneqq f^{-1}(e_H)$ and its *image* $\im f\coloneqq f(G)$.
