...
Proved by: [Natural numbers form an initial segment of ON](Natural%20numbers%20form%20an%20initial%20segment%20of%20ON.md), [[Well-ordering well-orders subsets]], [ON is well-ordered by membership](ON%20is%20well-ordered%20by%20membership.md)
