...
Properties: [Homogeneous system $A\v{x}=\v{0}$ with $A\sim I$ $\Leftrightarrow$ only trivial solution](Homogeneous%20linear%20system%20with%20coefficient%20matrix%20row-equivalent%20to%20identity%20matrix%20iff%20has%20only%20trivial%20solution.md), [$A\sim I$ $\Rightarrow$ $A\v{x}=\v{b}$ has a unique solution](Coefficient%20matrix%20row-equivalent%20identity%20implies%20linear%20system%20has%20unique%20solution.md)
...
_Let $K$ be a field and fix $n\in\N$. The **identity matrix of size $n$** is the matrix_
