...
* _The **action of $\pi_1\l(X,x_0\r)$ on fibers** is the action $\phi:\pi_1\l(X,x_0\r)\to\Aut\l(p^{-1}\!\l(x_0\r)\r)$ given by $\l[\gamma\r]\cdot\widetilde{x}\coloneqq\widetilde{\gamma}\l(0\r)$ where $\gamma$ is the lift of $\gamma$ ending at $\widetilde{x}$._
