...
<b>Remark.</b> The First Isomorphism Theorem shows that the sequence $0\longrightarrow A\overset{\phi}{\longrightarrow}B\overset{\psi}{\longrightarrow} C\longrightarrow0$ of groups is exact iff $C\iso B/A$.
