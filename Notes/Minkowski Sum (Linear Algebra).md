...
_Let_ $\l\{U_i\r\}_{i\in I}$ _be an indexed family of linear subspaces of a $K$-vector space $V$. The_ **_Minkowski sum of_ $\l\{U_i\r\}_{i\in I}$** _is the linear subspace_
$$\begin{equation}
