...
Properties: [$m\times n$ homogeneous linear system with $m<n$ $\Rightarrow$ non-trivial solutions](m%20by%20n%20homogeneous%20linear%20system%20with%20m<n%20has%20a%20non-trivial%20solution.md)
