...
* Fix $\ell\in\N$. An <b>$\ell$-ary inference rule</b> $R\in\mc{R}\l(\sigma\r)$ is an $(\ell+1)$-tuple of $\sigma$-formulas $\phi,\psi_1\dots,\psi_\ell$, written $\psi_1,\dots,\psi_\ell\infrule_R\phi$.
