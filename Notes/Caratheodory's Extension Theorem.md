...
* Recall that $\tpl{\pow\l(X\r),\symdiff}$ is an abelian group with $\em$ as its identity and with $A\symdiff A=\em$ for all $A\in\pow\l(X\r)$, where $A\symdiff B\coloneqq\l(A\comp B\r)\cup\l(B\comp A\r)=\l(A\cup B\r)\comp\l(A\cap B\r)$.
