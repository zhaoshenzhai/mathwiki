...
* For a $\sigma$-formula $\phi(v)$ and a $\sigma$-term $t(\vec{v})$ where no variable in $\vec{v}$ is quantified in $\phi$, the <i>substitution</i> of $t$ into $v$ in $\phi$ is the $\sigma$-formula $\phi\l(t/v\r)$ obtained by replacing each occurrence of $v$ by $t$.
...
together with a single inference rule of <i>Modus Ponens</i>: $\phi\rightarrow\psi,\phi\infrule_\MP\psi$.<span style="float:right;">$\blacklozenge$</span>
