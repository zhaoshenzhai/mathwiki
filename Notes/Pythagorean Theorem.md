...
$$\begin{align}
    \l\|\sum_{i=1}^m\alpha_iv_i\r\|^2&=\inprod{\sum_{i=1}^m\alpha_iv_i}{\sum_{j=1}^m\alpha_jv_j} && \textrm{Definition of $\|\slot\|$} \\
    &=\sum_{i=1}^m\sum_{j=1}^m\alpha_i\bar{\alpha_j}\inprod{v_i}{v_j} && \textrm{Sesquilinearity of }\inprod{\slot}{\slot} \\
    &=\sum_{i=1}^m\sum_{j=1}^m\alpha_i\bar{\alpha_j}\inprod{v_i}{v_i}\delta_{ij} && v_i\perp v_j\textrm{ for }i\neq j \\
