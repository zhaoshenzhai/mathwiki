...
* The <b>category of $G$-sets</b> is the category $\catgset$ whose objects are $G$-sets and whose morphisms are $G$-equivariant maps/
* A <b>$G$-isomorphism</b> is an isomorphism in $\catgset$; equivalently; it is a bijective $G$-equivariant map.
