...
* In a [principal ideal domain](Principal%20Ideal%20Domain%20(PID).md), one can, via [B$\acute{\textrm{e}}$zout$\textrm{'}$s Identity](Bezout's%20Identity.md), define the [greatest common divisor](Greatest%20Common%20Divisor%20(GCD).md) for any two ring elements.
