...
Examples: [[Trivial topology (explicit = basis)]], [[Discrete topology (explicit = basis)]], [[Order topology (basis = subbasis)]], [[Standard topology on R (explicit = basis; rational endpoints)]]
