...
_Let $\mb{R}$ be the set of real numbers. Then the upper limit topology_ $\mc{T}_\textrm{UL}$ _is strictly finer than the standard topology_ $\mc{T}_\textrm{st}$ _on $\mb{R}$._
