...
Proved by: [[Criteria for subbasis to generate existing basis]], [[Subset topology (Basis)]]
Generalizations: _Not Applicable_

!!! ad-Proposition Proposition.

_Let $\l\langle X,\mc{T}\r\rangle$ be a topological space and let $\mc{S}$ be a subbasis for $\mc{T}$. Fix a subset $Y\subseteq X$. Then the subset topology $\l.\mc{T}\r|_Y$ on $Y$ can be generated by the subbasis_
$$\begin{equation}
