...
$$\begin{equation}
    \mc{T}\l(\mc{B}\r)=\l\{U\in\mc{P}\l(X\r)\mid\fa x\in U,\ex B\in\mc{B}:x\in B\land B\subseteq U\r\},
\end{equation}$$
is a topology on $X$.
...
\end{equation}$$
Since $\mc{B}\subseteq\mc{P}\l(X\r)$, every $B\in\mc{B}$ is a subset of $X$ and thus $X\in\mc{T}\l(\mc{B}\r)$.
