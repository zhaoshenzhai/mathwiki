...
\begin{document}
    \begin{tikzpicture}[color=textColor]
        ...
        \fill[pattern=north west lines, dashed, pattern color=textColor] (-1,-2) rectangle (0,2);
        \fill[pattern=north east lines, dashed, pattern color=textColor] (-2,-0.75) rectangle (3,0);
