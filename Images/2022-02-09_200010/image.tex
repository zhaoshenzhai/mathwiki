...
\begin{document}
    \begin{tikzpicture}
        ...
        \filldraw (0,0) circle (0.25mm) node[below right, text=textColor] {\footnotesize{$x$}};
        \draw[dashed] (0,0) circle (0.75) node[above right=7mm, text=textColor] {\footnotesize{$B$}};
    \end{tikzpicture}
\end{document}
